...
.btn_ {
    ...
    filter: progid: DXImageTransform.Microsoftient(startColorstr='#ffffffff', endColorstr='#ffe6e6e6', GradientType=0);
...
.placement{
	...
	font-size: 20px;
	color: black;
        text-shadow: 2px 2px 5px #828282;
        position: relative;
        top: -20px;
}
.capsule{
...
.login_content form input[type="password"]:focus {
    ...
    box-shadow: 0 0 2px #0000000 inset;
    background-color: #fff;
...
<div class="grad">
<div class="image">
	<img src="logo_new.png" width="200px" height= "125px">
</div>
...
<div>
	...
	<h1><center>PLACEMENT PORTAL</h1>
		    ...
		    <div class = "name_title">
                         ...
                         <input type="text" id="userName" name="userName" placeholder="Username" style= "border-radius = 10px" required="" />
                         </div>
                    ...
                    <div>
                        ...
                        <button class="capsule" type="submit" name="login" >Log in</button>
                        <br>
                    ...
                    <div class="separator">
                        ...
                        <div>
			    <br>
                            <h1><i class="fa-paw"> Meow Group !</i></h1>
            ...
            <section class="login_content">
                <form>
                    ...
                    <div class="separator">
                        ...
                        <div>
                            <h1><i class="fa fa-paw"></i> Meow Group !</h1>
