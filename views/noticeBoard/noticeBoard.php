            ...
            <div class="">
                ...
                <div class="page-title">
                    <div class="title_left">
                        <h3 style="font-family:Montserrat;color:black">Notice <small>Board</small></h3>
                    </div>
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered">
                                    ...
                                    foreach ($events as $event){
                                        ?>
                                        <tr>
                                            <td><?=$event['event_name1']?></td>
                                            <td><?=$event['event_date1']?></td>
                                            <td><?=$event['event_time1']?></td>
                                            <td><?=$event['event_type1']?></td>
...
<br>
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    <?php
                                    foreach ($offline as $notice){
                                        ?>
                                        <tr>
                                            <td><?=$notice['event_name']?></td>
                                            <td><?=$notice['event_date']?></td>
                                            <td><?=$notice['event_time']?></td>
                                            <td><?=$notice['event_type']?></td>
					    <td><?=$notice['guest']?></td>
					    <td><?=$notice['venue']?></td>
                                            <td>
                                                <?php
