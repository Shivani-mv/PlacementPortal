...
//
//print_r($conn->getAll("SELECT * FROM `offline`"));
            ...
            <div class="">
                <div class="page-title">
                    <div class="title_left">
                        ...
                        <h3 style="font-family:Montserrat;color:black">Create Offline Event <small> Only for admins and co-ordinators</small></h3>
                    </div>
