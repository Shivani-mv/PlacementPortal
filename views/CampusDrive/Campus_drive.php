...
$com=$conn->getAll("SELECT * FROM `company`");
            ...
            <div class="">
                ...
                <div class="page-title">
                    <div class="title_left">
                        <h3 style="font-family:Montserrat;color:black;font-size:30px">Campus Drive</h3>
                    </div>
                        ...
                        <div class="x_panel">
                            <div class="x_content">
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    <?php
                                    foreach ($com as $notice){
                                    ?>
                                    <tr>
                                        <td><?=$notice['company_name']?></td>
                                        <td><?=$notice['visit_date']?></td>
                                        <td><?=$notice['visit_time']?></td>
                                        <td><?=$notice['company_type']?></td>
                                        <td><?=$notice['cut_off']?></td>
                                        <td><?=$notice['venue1']?></td>
                                        <td>
                                            <?php
                                            if($notice['status3']==1){
